...
import com.example.tryagain.Adapter.Bank_User_Adapter;
import com.example.tryagain.Model.Bank_Payment;
...
public class Bank_User_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bank_user_adapter = new Bank_User_Adapter(paymentArrayList, new Bank_User_Adapter.ItemClickListener() {
            ...
            public void onItemClick(Bank_Payment bank_user) {
                Intent intent = new Intent(Bank_User_Activity.this, User_Bank_Information_Activity.class);
        ...
        tv_add_user_bank.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Bank_User_Activity.this, Bank_Activity.class);
