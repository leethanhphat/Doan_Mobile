...
import com.example.tryagain.Activity.Bank_User_Activity;
import com.example.tryagain.Activity.Cart_Activity;
import com.example.tryagain.Activity.History_Parent_Activity;
import com.example.tryagain.Activity.LoginActivity;
import com.example.tryagain.Activity.User_Information_Activity;
...
public class SettingFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tv_user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), User_Information_Activity.class);
                startActivity(intent);
            }
        });
        ...
        tv_user_bank.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), Bank_User_Activity.class);
                startActivity(intent);
            }
        });
