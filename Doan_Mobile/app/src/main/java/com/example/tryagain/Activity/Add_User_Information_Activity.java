package com.example.tryagain.Activity;
...
public class Add_User_Information_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (img_uri != null) {
                    SaveData_Info();
                    ProgressDialog.show(Add_User_Information_Activity.this, "", "Đang khởi tạo tài khoản...", true);

                } else {
                    Toast.makeText(Add_User_Information_Activity.this, "Chưa chọn ảnh", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            mRef1.child(user1.getUid()).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener() {
                                ...
                                public void onSuccess(Object o) {
                                    Intent intent = new Intent(Add_User_Information_Activity.this, MainActivity.class);
